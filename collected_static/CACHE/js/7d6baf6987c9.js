    ...
    // populate trader data as update
        ...
        var ndata = jQuery.extend(true, [], data);
            ...
            if (result.length != 0) {
                ...
                result[0].traderbuyvolume = 1082;
                result[0].tradersellvolume = 1003;
            } else {
        ...
        var ndata = jQuery.extend(true, [], data);
            ...
            if (result.length != 0) {
                result[0].traderprice = 97.0;
                result[0].traderbuyvolume = 588;
                result[0].tradersellvolume = 1138;
            } else {

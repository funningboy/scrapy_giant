    ...
    // populate trader data as update
        ...
        var ndata = jQuery.extend(true, [], data);
            ...
            if (result.length != 0) {
                ...
                result[0].traderbuyvolume = 37;
                result[0].tradersellvolume = 1021;
            } else {
        ...
        var ndata = jQuery.extend(true, [], data);
            ...
            if (result.length != 0) {
                ...
                result[0].tradersellvolume = 200;
            } else {
                
            }
        
        var unit = {
            "traderidnm": "9661-富邦新店",
            "stockidnm": "2317-鴻海",
            "tradervolume": "200",
            "url": "",
            "description": "",

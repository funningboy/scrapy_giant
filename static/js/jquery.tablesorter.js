 ...
 * @desc Create a tablesorter interface and sort on the first and secound
 ...
 *         "header"
 * 
 * @option String cssAsc (optional) A string of the class name to be appended
 * to
 *         sortable tr elements in the thead on a ascending sort. Default
 *         value:
 *         "headerSortUp"
 * 
 ...
 * 
 * 
 * @option Array sortAppend (optional) An array containing forced sorting
 * rules.
 *         This option let's you specify a default sorting rule, which is
        ...
        function () {
            ...
            function multisort(table, sortList, cache) {
                ...
                for (var i = 0; i < l; i++) {
                    ...
                    // var s = (getCachedSortType(table.config.parsers,c) ==
                    // "text") ?
                    // ((order == 0) ? "sortText" : "sortTextDesc") : ((order
                    // == 0) ?
